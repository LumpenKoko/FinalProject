                        ...
                        <div id="main_main_left">
                            ...
                            <div id="main_main_left2">
                                ...
                                <div style="border-style: none;" id="petInfo"
                                    onclick="location.href='<%=request.getContextPath()%>/myPagePetInfo.mp'">반려동물 정보</div>
                            </div>
                        ...
                        <form id="main_main_right" action="">
                            ...
                            <div id="id-input">
                                ...
                                <input type="text" placeholder="userId"
                                 style="border-radius: 15px; border: 1px solid #bababa; margin-top: 0px; width: 80%; float: left;
                            ...
                            <div id="birth-input">
                                ...
                                <input type="text" placeholder="1998-11-20"
                                 style="border-radius: 15px; border: 1px solid #bababa; margin-top: 0px; width: 80%; float: left;
                                  height: 50px; text-align: left; padding-left: 20px;">
                            </div>
                            <div id="email-input" style="display: flex; margin-left: 70px; margin-top: 50px; justify-content: space-between;">
                                <input type="text" placeholder="userEmail" style="width: 300px; height: 50px; border-radius: 15px;
                                 border: 1px solid #bababa;">
                                <p style="font-size: 22px;">@</p>
                                <select id="website" style="border-radius: 15px; width: 300px; border: 1px solid #bababa; margin-right: 165px;">
                            ...
                            <button type="submit" style="width: 80%; align-items: center; margin-top: 50px;
                             ...
                             <div style="width: 80%; margin-top: 50px; margin-left: 70px; font-size: 19px; margin-bottom: 30px;">
